...
export const i18n = {
    fr: {
        ...
        pricingSub: "Deux formules claires. Zéro engagement.",
        tiers: [
            {
                name: "DIAGNOSTIC", price: "250\u20ac", period: "/rapport", badge: "", annual: "", color: C.accent,
                tagline: "Cadrage industriel et stratégique",
                features: [
                    "AEGIS Intelligence — analyse d'impact réglementaire IA",
                    "Tous secteurs industriels EU",
                    "Kanban recommandations stratégiques",
                    "Feuille de route Gantt PDF complet",
                    "Fil d'actualités multi-secteurs",
            ...
            },
            {
                ...
                tagline: "Expertise R&D terrain + IA réglementaire",
                features: [
        ...
        trinityItem1Desc: "De la conception à la série — automobile, batteries, ferroviaire, défense",
        ...
        trinityItem3Desc: "Analyse d'impact en <30s — alimentée par l'expérience terrain",
        trinityResult: "Votre conformité industrielle, pilotée par l'expertise R&D terrain et l'IA réglementaire AEGIS.",
    ...
    en: {
        ...
        pricingSub: "Two clear plans. Zero commitment.",
        tiers: [
            {
                name: "DIAGNOSTIC", price: "\u20ac250", period: "/report", badge: "", annual: "", color: C.accent,
                tagline: "Industrial & strategic assessment",
                features: [
            ...
            },
            {
                ...
                tagline: "Field R&D expertise + regulatory AI",
                features: [
        ...
        trinityItem3Desc: "Impact analysis in <30s — powered by field experience",
        trinityResult: "Your industrial compliance, driven by field R&D expertise and AEGIS regulatory AI.",
        // v3.1 Cookie Banner RGPD
