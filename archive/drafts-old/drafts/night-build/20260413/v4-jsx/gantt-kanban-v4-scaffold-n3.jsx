// =====================================================================
// AEGIS Intelligence — Gantt Kanban Governance Dashboard v4.0 — N3
// =====================================================================
// Source PRS : 20260410T1400_SPEC_GANTT-KANBAN-V4-PRS.md
// Auteur scaffold : Claude Code (ACDC) — Night Builder N1 (T0000) + N2 (T2225) + N3 (T2200)
// Date scaffold : 20260412T2200 CET
// Statut : DRAFT NOCTURNE N3 — pre-review Opus Chat matinal 13/04
...
// N3 ajouts : 7 sprints 3 swimlanes manquantes (P1) + viewport ms-14/ms-15 (P2) + drag visual feedback (P3) + bar stacking
// =====================================================================
...
function GanttView({ state, dispatch }: { state: AppState; dispatch: React.Dispatch<AppAction> }) {
  ...
  // N3 : compute bar rows pour stacking
  const barRows = useMemo(() => computeBarRows(visibleSprints), [visibleSprints]);
  ...
  return (
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", backgroundColor: P.bg, color: P.text, minHeight: "100vh" }}>
      ...
      <footer style={{ padding: "12px 24px", borderTop: `1px solid ${P.border}`, fontSize: 10, color: P.muted, fontFamily: "monospace" }}>
        v4.0 N3 — Regime D10r2 — Convention D48 — {TODAY}
      </footer>
    </div>
  );
}
