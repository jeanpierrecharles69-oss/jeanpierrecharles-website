...
export const getModules = (lang: Language): RegulationModule[] => {
  ...
  return [
    ...
    },
    {
      ...
      icon: GlobeAltIcon,
      description: isFr
        ? 'Exigences ERSP, Règlement Batteries et CRMA. Empreinte carbone et circularité des matériaux.'
        : 'ERSP requirements, Batteries Regulation, and CRMA. Carbon footprint and material circularity.',
      complianceItems: [
        {
          id: '5-1',
