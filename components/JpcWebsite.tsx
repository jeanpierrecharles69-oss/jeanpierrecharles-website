        ...
        <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="relative">
                    ...
                    <div className="relative bg-white rounded-3xl p-10 h-96 flex items-center justify-center border border-slate-100 shadow-lg overflow-hidden group">
                        <div className="text-center w-full h-full flex flex-col items-center justify-center">
                            {/* Initials Bubble Main */}
                            <div className="h-28 w-28 bg-slate-900 rounded-full mx-auto shadow-xl flex items-center justify-center mb-6 border-4 border-white transition-transform duration-500 hover:scale-105">
                                <span className="text-3xl font-bold text-white tracking-wider">JPC</span>
                            </div>
                            <p className="font-serif italic text-xl text-slate-500 rotate-[-1deg]">"L'excellence par l'humain"</p>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div className="mt-8 grid grid-cols-2 gap-4">
                        <div className="p-5 bg-white rounded-xl border border-slate-200 shadow-sm">
                            ...
                            <p className="text-sm text-slate-600 font-medium">Redonner le pouvoir aux équipes.</p>
                        </div>
                        <div className="p-5 bg-white rounded-xl border border-slate-200 shadow-sm">
                            <h4 className="font-bold text-slate-900 text-base mb-1">Robustesse</h4>
                            <p className="text-sm text-slate-600 font-medium">Des systèmes fiables et durables.</p>
                        </div>
                    </div>
                </div>
            </div>
